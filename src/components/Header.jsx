...
const Header = () => {
  return (
    <div className=' w-[100vw] h-[7vh] text-white text-xl z-50 flex justify-between items-center px-20 bg-gradient-to-b from-black/50 to-transparent backdrop-blur-sm '>
            ...
            <div className="links flex gap-10 items-center  text-white text-xl ">
                ...
                <a href="" className='border px-5 py-2 hover:bg-white/10 transition-colors duration-300'>Reserver</a>
            </div>
